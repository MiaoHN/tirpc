...
static void InitDefaultsscc_info_queryAgeReq_tinypb_5fserver_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_queryAgeReq_tinypb_5fserver_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_queryAgeReq_tinypb_5fserver_2eproto}, {}};

static void InitDefaultsscc_info_queryAgeRes_tinypb_5fserver_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_queryAgeRes_tinypb_5fserver_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_queryAgeRes_tinypb_5fserver_2eproto}, {}};

static void InitDefaultsscc_info_queryNameReq_tinypb_5fserver_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_queryNameReq_tinypb_5fserver_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_queryNameReq_tinypb_5fserver_2eproto}, {}};

static void InitDefaultsscc_info_queryNameRes_tinypb_5fserver_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_queryNameRes_tinypb_5fserver_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_queryNameRes_tinypb_5fserver_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_tinypb_5fserver_2eproto[4];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_tinypb_5fserver_2eproto = nullptr;
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_tinypb_5fserver_2eproto[1];

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_tinypb_5fserver_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_tinypb_5fserver_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "vice\022*\n\nquery_name\022\r.queryNameReq\032\r.quer"
  "yNameRes\022\'\n\tquery_age\022\014.queryAgeReq\032\014.qu"
  "eryAgeResB\003\200\001\001b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_tinypb_5fserver_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_tinypb_5fserver_2eproto_sccs[4] = {
  &scc_info_queryAgeReq_tinypb_5fserver_2eproto.base,
  &scc_info_queryAgeRes_tinypb_5fserver_2eproto.base,
  &scc_info_queryNameReq_tinypb_5fserver_2eproto.base,
  &scc_info_queryNameRes_tinypb_5fserver_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_tinypb_5fserver_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tinypb_5fserver_2eproto = {
  false, false, descriptor_table_protodef_tinypb_5fserver_2eproto, "tinypb_server.proto", 422,
  &descriptor_table_tinypb_5fserver_2eproto_once, descriptor_table_tinypb_5fserver_2eproto_sccs, descriptor_table_tinypb_5fserver_2eproto_deps, 4, 0,
  schemas, file_default_instances, TableStruct_tinypb_5fserver_2eproto::offsets,
  file_level_metadata_tinypb_5fserver_2eproto, 4, file_level_enum_descriptors_tinypb_5fserver_2eproto, file_level_service_descriptors_tinypb_5fserver_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_tinypb_5fserver_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_tinypb_5fserver_2eproto)), true);
...
const queryAgeReq& queryAgeReq::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_queryAgeReq_tinypb_5fserver_2eproto.base);
...
void queryAgeRes::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_queryAgeRes_tinypb_5fserver_2eproto.base);
  res_info_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
const queryNameReq& queryNameReq::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_queryNameReq_tinypb_5fserver_2eproto.base);
  return *internal_default_instance();
}
...
void queryNameRes::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_queryNameRes_tinypb_5fserver_2eproto.base);
  res_info_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&ret_code_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&id_) -
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* QueryService::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_tinypb_5fserver_2eproto);
  return file_level_service_descriptors_tinypb_5fserver_2eproto[0];
}
...
void QueryService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_tinypb_5fserver_2eproto[0]);
  switch(method->index()) {
    case 0:
